...
public class HttpClientUtil {
	public static void main(String[] args) throws Exception {
		...
		params.put("username", "AC1356");
		params.put("password", "shyf1356");
		sendSSLPostRequest("https://auchan.chinab2bi.com/j_spring_security_check.hlt", params);
	}
	...
	public static String sendSSLPostRequest(String reqURL, Map<String, String> params) {
		...
		try {
			...
			httpGet.setHeaders(response.getAllHeaders());
