							...
							<li>
								...
								<div class="row" data-bind="click : $root.detail">
									...
									<div class="row">
										...
										<div class="four columns">
											<span data-bind="text : contractor"></span>, <img alt="电话号码" data-bind="attr: { 'src' : phone_src }">
										</div>
										<div class="four columns">
									...
									<div class="row companydetail" style="display: none;">
										...
										<form>
											<fieldset>
												<legend><b>具体细节</b></legend>
												<div class="row">
													<div class="six columns">
														<label>地址 </label> <input type="text" data-bind="value : address">
													</div>
													<div class="six columns">
														<label>电子邮件</label> <img alt="电子邮箱" data-bind="attr: { 'src' : email_src }">
													</div>
												</div>
												<div class="row">
													<div class="three columns">
														<label>关注点</label> 
														<label class="input-checkbox selected" for="ex-chx-a">
															<input type="checkbox" name="ex-checkbox" id="ex-chx-a" value="1" /> 留不住人
														</label> 
														<label class=".selected input-checkbox" for="ex-chx-b"> 
															<input type="checkbox" name="ex-checkbox" id="ex-chx-b" value="2" /> 留不住客户
														</label>
													</div>
													<div class="three columns">
														<label>进展</label> 
														<label class="input-checkbox selected" for="ex-chx-a">
															<input type="checkbox" name="ex-checkbox" id="ex-chx-a" value="1" /> 第一次沟通
														</label> 
														<label class=".selected input-checkbox" for="ex-chx-b"> 
															<input type="checkbox" name="ex-checkbox" id="ex-chx-b" value="2" /> 希望不大
														</label>
													</div>
													<div class="six columns">
														<label>客户描述</label>
